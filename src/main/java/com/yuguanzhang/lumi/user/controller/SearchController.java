...
public class SearchController {
    ...
    public BaseResponseDto<SearchResoponseDto> searchUserProfile(@RequestParam final UUID userId) {
        SearchResoponseDto responseDto = searchService.searchUser(userId);
